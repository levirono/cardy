    ...
    <UCard>
      <template #header>
        <div class="flex items-center justify-between">
          <h2 class="text-lg font-semibold">Request print & delivery</h2>
          <UButton :to="`/card/${route.params.id}`" color="neutral" variant="ghost" icon="i-heroicons-arrow-uturn-left" />
        </div>
      </template>

      <div v-if="!card" class="text-gray-500">Card not found.</div>
